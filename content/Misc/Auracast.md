...
[![[saucygibbon.png|450]]](https://the-goodies-rule.fandom.com/wiki/Radio_Goodies)
...
The catch at present: as of mid-2025 it's still "too new" and there are many half-baked implementations. One of the most egregious examples is JBL: despite apparently licensing the Auracast trademark, etc, their products cannot be used to receive from non-JBL Auracast transmitters. Their app provides no facility to scan for or select arbitrary broadcasts (they seem to have hard-coded a stream ID in their devices?). Hopefully they will provide an update at some point that properly supports Auracast. [We'll see](https://www.reddit.com/r/auracastBT/).
