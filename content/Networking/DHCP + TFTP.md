...
In the beginning … there was [BOOTP](https://en.wikipedia.org/wiki/Bootstrap_Protocol "https://en.wikipedia.org/wiki/Bootstrap_Protocol") ([RFC951](https://tools.ietf.org/html/rfc951 "https://tools.ietf.org/html/rfc951")). Then, BOOTP begat [DHCP](https://en.wikipedia.org/wiki/Dynamic_Host_Configuration_Protocol "https://en.wikipedia.org/wiki/Dynamic_Host_Configuration_Protocol") ([RFC2131](https://tools.ietf.org/html/rfc2131 "https://tools.ietf.org/html/rfc2131")). The problem is bits of BOOTP are embedded in DHCP and certain situations raise all kinds of ambiguities and broken systems. [TFTP](https://en.wikipedia.org/wiki/Trivial_File_Transfer_Protocol) is one of these situations.
